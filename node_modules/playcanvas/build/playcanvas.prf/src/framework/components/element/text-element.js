		...
		for (let i = 0; i < this._meshInfo.length; i++) {
			...
			for (const line in this._meshInfo[i].lines) {
				...
				for (let quad2 = prevQuad; quad2 <= index; quad2++) {
					this._meshInfo[i].positions[quad2 * 4 * 3] += hoffset;
					this._meshInfo[i].positions[quad2 * 4 * 3 + 3] += hoffset;
					this._meshInfo[i].positions[quad2 * 4 * 3 + 6] += hoffset;
					this._meshInfo[i].positions[quad2 * 4 * 3 + 9] += hoffset;
