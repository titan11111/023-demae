...
export class StandardMaterial extends Material {
	...
	/** Intensity Defines amount of anisotropy. Requires {@link enableGGXSpecular} is set to true. - When anisotropyIntensity == 0, specular is isotropic. - Specular anisotropy increases as anisotropyIntensity value increases to maximum of 1. */
	...
	/** Force inclusion of the constant `specular` color when compositing with `specularMap` and/or specular vertex colors. Defaults to `false`. Setting this to `true` is rarely needed - the constant is automatically applied whenever `specular` differs from white. Provided as an explicit override. */
