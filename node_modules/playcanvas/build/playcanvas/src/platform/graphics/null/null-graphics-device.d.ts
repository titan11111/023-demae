export class NullGraphicsDevice extends GraphicsDevice {
    ...
    createUniformBufferImpl(uniformBuffer: any): NullUniformBuffer;
    createBindGroupImpl(bindGroup: any): NullBindGroup;
    createBindGroupFormatImpl(bindGroupFormat: any): NullBindGroupFormat;
    setBindGroup(index: any, bindGroup: any, offsets: any): void;
