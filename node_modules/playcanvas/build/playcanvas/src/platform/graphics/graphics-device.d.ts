...
export class GraphicsDevice extends EventHandler {
    ...
    setBlendFunction(blendSrc: any, blendDst: any): void;
    setBlendFunctionSeparate(blendSrc: any, blendDst: any, blendSrcAlpha: any, blendDstAlpha: any): void;
    setBlendEquation(blendEquation: any): void;
    setBlendEquationSeparate(blendEquation: any, blendAlphaEquation: any): void;
    setColorWrite(redWrite: any, greenWrite: any, blueWrite: any, alphaWrite: any): void;
    getBlending(): boolean;
    setBlending(blending: any): void;
    setDepthWrite(write: any): void;
    setDepthFunc(func: any): void;
    setDepthTest(test: any): void;
    getCullMode(): number;
    /**
