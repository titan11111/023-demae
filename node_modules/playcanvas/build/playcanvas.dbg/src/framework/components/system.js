...
class ComponentSystem extends EventHandler {
  ...
  constructor(app) {
     ...
     * @ignore
     */
    __publicField(this, "extraDataProperties", []);
    /**
     ...
     * @ignore
     */
    __publicField(this, "_validProps", null);
    this.app = app;
    this.store = {};
    this.schema = [];
  }
...
function isSettableProperty(obj, key) {
  ...
  Debug.call(() => {
    for (let proto = obj; proto && proto !== Object.prototype; proto = Object.getPrototypeOf(proto)) {
      ...
      if (descriptor) {
        settable = descriptor.set !== void 0 || descriptor.writable === true;
        return;
      }
    }
  });
...
function validateComponentOptions(system, component, data) {
  Debug.call(() => {
    const valid = system._validProps ?? (system._validProps = /* @__PURE__ */ new Set(["enabled", ...system.extraDataProperties]));
