...
class TranslateGizmo extends TransformGizmo {
  ...
  constructor(camera, layer) {
     ...
     * @private
     */
    __publicField(this, "_nodeLocalPositions", /* @__PURE__ */ new Map());
    /**
     ...
     * @private
     */
    __publicField(this, "_nodePositions", /* @__PURE__ */ new Map());
    /** @override */
    ...
    this.on(TransformGizmo.EVENT_TRANSFORMMOVE, (point2) => {
      const translateDelta = delta.copy(point2).sub(this._selectionStartPoint);
      if (this.snap) {
