...
`)),t}static _preprocess(t,e=new Map,i,s,a){var f;const r=t,n=[];let l=!1,d;for(;(d=ke.exec(t))!==null&&!l;){const h=d[1];switch(h){case"define":{rr.lastIndex=d.index;const u=rr.exec(t);l||(l=u===null);const m=u[1];rl.lastIndex=u.index;const g=rl.exec(m)[0];let v=m.substring(g.length).trim();v===""&&(v="true");const E=he._keep(n);let S=a;if(E){const T=g.startsWith("{")&&g.endsWith("}");T&&(S=!0),T?i.set(g,v):e.set(g,v),S&&(t=t.substring(0,u.index-1)+t.substring(rr.lastIndex),ke.lastIndex=u.index-1)}S||(ke.lastIndex=u.index+u[0].length);break}case"undef":{nr.lastIndex=d.index;const u=nr.exec(t),m=u[1].trim();he._keep(n)&&(e.delete(m),a&&(t=t.substring(0,u.index-1)+t.substring(nr.lastIndex),ke.lastIndex=u.index-1)),a||(ke.lastIndex=u.index+u[0].length);break}case"extension":{al.lastIndex=d.index;const u=al.exec(t);if(l||(l=u===null),u){const m=u[1];he._keep(n)&&e.set(m,"true")}ke.lastIndex=u.index+u[0].length;break}case"ifdef":case"ifndef":case"if":{or.lastIndex=d.index;const u=or.exec(t),m=u[2],p=he.evaluate(m,e);l||(l=p.error);let g=p.result;h==="ifndef"&&(g=!g),n.push({anyKeep:g,keep:g,start:d.index,end:or.lastIndex}),ke.lastIndex=u.index+u[0].length;break}case"endif":case"else":case"elif":{lr.lastIndex=d.index;const u=lr.exec(t),m=n.pop();if(!m){console.error(`Shader preprocessing encountered "#${u[1]}" without a preceding #if #ifdef #ifndef while preprocessing ${he.sourceName} on line:
 ${t.substring(d.index,d.index+100)}...`,{source:r}),l=!0;continue}const p=m.keep?t.substring(m.end,d.index):"";t=t.substring(0,m.start)+p+t.substring(lr.lastIndex),ke.lastIndex=m.start+p.length;const g=u[1];if(g==="else"||g==="elif"){let v=!1;if(!m.anyKeep)if(g==="else")v=!m.keep;else{const E=he.evaluate(u[2],e);v=E.result,l||(l=E.error)}n.push({anyKeep:m.anyKeep||v,keep:v,start:ke.lastIndex,end:ke.lastIndex})}break}case"include":{cr.lastIndex=d.index;const u=cr.exec(t);if(l||(l=u===null),!u){l=!0;continue}const m=u[1].trim(),p=(f=u[2])==null?void 0:f.trim();if(he._keep(n)){let v=s==null?void 0:s.get(m);if(v!==void 0){if(v=this.stripComments(v),p){const E=e.get(p),S=parseFloat(E);if(Number.isInteger(S)){let T="";for(let y=0;y<S;y++)T+=v.replace(pm,String(y));v=T}else console.error(`Include Count identifier "${p}" not resolved while preprocessing ${he.sourceName} on line:
 ${t.substring(d.index,d.index+100)}...`,{originalSource:r,source:t}),l=!0}t=t.substring(0,u.index-1)+v+t.substring(cr.lastIndex),ke.lastIndex=u.index-1}else{console.error(`Include "${m}" not resolved while preprocessing ${he.sourceName}`,{originalSource:r,source:t}),l=!0;continue}}break}}}return n.length>0&&(console.error(`Shader preprocessing reached the end of the file without encountering the necessary #endif to close a preceding #if, #ifdef, or #ifndef block. ${he.sourceName}`),l=!0),l?(console.error("Failed to preprocess shader: ",{source:r}),null):t}static _keep(t){for(let e=0;e<t.length;e++)if(!t[e].keep)return!1;return!0}static evaluateAtomicExpression(t,e){let i=!1;t=t.trim();let s=!1;if(t==="true")return{result:!0,error:i};if(t==="false")return{result:!1,error:i};if(_m.test(t))return{result:parseFloat(t)!==0,error:i};const a=dm.exec(t);if(a){s=a[1]==="!",t=a[2].trim();const l=e.has(t);return{result:s?!l:l,error:i}}const r=um.exec(t);if(r){const l=e.get(r[1].trim())??r[1].trim(),d=e.get(r[3].trim())??r[3].trim(),f=r[2].trim();let h=!1;switch(f){case"==":h=l===d;break;case"!=":h=l!==d;break;case"<":h=l<d;break;case"<=":h=l<=d;break;case">":h=l>d;break;case">=":h=l>=d;break;default:i=!0}return{result:h,error:i}}return{result:e.has(t),error:i}}static processParentheses(t,e){let i=!1,s=t.trim();for(;s.startsWith("(")&&s.endsWith(")");){let a=0,r=!0;for(let n=0;n<s.length-1;n++)if(s[n]==="(")a++;else if(s[n]===")"&&(a--,a===0)){r=!1;break}if(r)s=s.slice(1,-1).trim();else break}for(;;){let a=!1,r=0,n=0,l=-1,d=-1,f=0;for(let p=0;p<s.length;p++)if(s[p]==="("){const g=s.substring(0,p);fm.test(g)?f++:f===0&&(r++,r>n&&(n=r,l=p),a=!0)}else s[p]===")"&&(f>0?f--:r>0&&(r===n&&l!==-1&&(d=p),r--));if(!a||l===-1||d===-1)break;const h=s.substring(l+1,d),{result:u,error:m}=he.evaluate(h,e);i=i||m,s=s.substring(0,l)+(u?"true":"false")+s.substring(d+1)}return{expression:s,error:i}}static evaluate(t,e){const i=mm.exec(t)===null;let s=t,a=!1;if(t.replace(hm,"").indexOf("(")!==-1){const l=he.processParentheses(t,e);s=l.expression,a=l.error}if(a)return{result:!1,error:!0};const n=s.split("||");for(const l of n){const d=l.split("&&");let f=!0;for(const h of d){const{result:u,error:m}=he.evaluateAtomicExpression(h.trim(),e);if(!u||m){f=!1;break}}if(f)return{result:!0,error:!i}}return{result:!1,error:!i}}};o(he,"sourceName");let fs=he;var Vd=`
#ifndef outType_0
...
#endif
`;const gm={vertex_position:ge,vertex_normal:bi,vertex_tangent:Ni,vertex_texCoord0:Ua,vertex_texCoord1:Ba,vertex_texCoord2:dd,vertex_texCoord3:hd,vertex_texCoord4:fd,vertex_texCoord5:ud,vertex_texCoord6:md,vertex_texCoord7:pd,vertex_color:gt,vertex_boneIndices:ri,vertex_boneWeights:ai};class _e{static createDefinition(t,e){const i=u=>{let m=u.fragmentOutputTypes??"vec4";return Array.isArray(m)||(m=[m]),m},s=(u,m,p,g)=>{const v=t.isWebGPU?u:m;let E="";if(!p){const S=i(g);for(let T=0;T<t.maxColorAttachments;T++){E+=`#define COLOR_ATTACHMENT_${T}
`;const y=S[T]??"vec4";E+=`#define outType_${T} ${y}
`}}return E+v},a=(u,m)=>{let p=_e.getWGSLEnables(t,u?"vertex":"fragment");if(!u){const g=i(m);for(let v=0;v<t.maxColorAttachments;v++){const E=g[v]??"vec4",S=Fd.get(E);p+=`alias pcOutType${v} = ${S};
`}}return p},r=e.name??"Untitled";let n,l;const d=_e.getDefinesCode(t,e.vertexDefines),f=_e.getDefinesCode(t,e.fragmentDefines);return e.shaderLanguage===ue?(n=`
								${a(!0,e)}
								${d}
								${pn}
								${Yd}
...
`)}getStream(t){let e=this.streams.find(i=>i.name===t);return e||(e=this._extraStreams.find(i=>i.name===t)),e}_invalidateCaches(){this._hash=void 0,this._resourceStreams=null,this._instanceStreams=null}static createDefaultFormat(t){return new Ps(t,[{name:"dataColor",format:Ue},{name:"dataCenter",format:at},{name:"dataScale",format:Ue},{name:"dataRotation",format:Ue}],{readGLSL:ig,readWGSL:sg})}static createSimpleFormat(t){return new Ps(t,[{name:"dataCenter",format:at},{name:"dataColor",format:Ue}],{readGLSL:ag,readWGSL:rg})}}const tc=8;var dg=`
...
`;const vg={[Ye]:["float","vec2","vec3","vec4"],[kn]:["int","ivec2","ivec3","ivec4"],[ka]:["uint","uvec2","uvec3","uvec4"]},Sg={[Ye]:["f32","vec2f","vec3f","vec4f"],[kn]:["i32","vec2i","vec3i","vec4i"],[ka]:["u32","vec2u","vec3u","vec4u"]},Tg=["x","y","z","w"],ic=/\{name\}/g,Eg=/\{type\}/g,yg=/\{funcName\}/g,xg=/\{word\}/g,sc=/\{value\}/g,Cg=["gsplatUserVaryingsVS","gsplatUserVaryingsPS"],wg=["gsplatUserVaryingsVS","gsplatUserVaryingsFlushVS","gsplatUserVaryingsCS","gsplatUserVaryingsPS","gsplatUserCacheWriteCS","gsplatUserCacheReadVS"],Ag=c=>c.charAt(0).toUpperCase()+c.slice(1),Lg=(c,t)=>c===ka?t:`bitcast<u32>(${t})`,Dg=(c,t)=>c===ka?t:c===kn?`bitcast<i32>(${t})`:`bitcast<f32>(${t})`;class Pg{constructor(t){o(this,"_device");o(this,"_streams",[]);o(this,"_words",0);o(this,"_version",0);this._device=t}get streams(){return this._streams}get words(){return this._words}get version(){return this._version}add(t){for(const e of t)this._streams.push({name:e.name,type:e.type,components:e.components});this._changed()}remove(t){const e=this._streams.length;this._streams=this._streams.filter(i=>!t.includes(i.name)),this._streams.length!==e&&this._changed()}_changed(){this._words=this._streams.reduce((t,e)=>t+e.components,0),this._version++}_generateChunks(){const t=this._device.isWebGPU,e=t?Sg:vg,i=t?fg:dg,s=t?pg:hg,a=[],r=[],n=[],l=[],d=[],f=[];let h=0;for(const m of this._streams){const{name:p,type:g,components:v}=m,E=e[g][v-1],S=Ag(p),T=y=>y.replace(ic,p).replace(Eg,E).replace(yg,S);if(a.push(T(i)),r.push(T(s)),t){n.push(T(ug)),l.push(T(mg));const y=[];for(let C=0;C<v;C++){const x=v===1?`_user_${p}`:`_user_${p}.${Tg[C]}`;d.push(_g.replace(xg,String(tc+h+C)).replace(sc,Lg(g,x))),y.push(Dg(g,`projCache[base + ${tc+h+C}u]`))}f.push(gg.replace(ic,p).replace(sc,v===1?y[0]:`${E}(${y.join(", ")})`))}h+=v}const u={gsplatUserVaryingsVS:a.join(""),gsplatUserVaryingsPS:r.join("")};return t&&(u.gsplatUserVaryingsFlushVS=n.join(""),u.gsplatUserVaryingsCS=l.join(""),u.gsplatUserCacheWriteCS=d.join(""),u.gsplatUserCacheReadVS=f.join("")),u}apply(t){const e=this._device.isWebGPU,i=t.getShaderChunks(e?ue:ae);if(t.setDefine("GSPLAT_USER_VARYINGS",this._streams.length>0),this._streams.length>0){const s=this._generateChunks();for(const a in s)i.set(a,s[a])}else(e?wg:Cg).forEach(a=>i.delete(a));t.update()}}var Ig=`
...
`;class Bg{constructor(t){o(this,"_material",new Ds);o(this,"_format");o(this,"_device");o(this,"_dataFormat",mr);o(this,"radialSorting",!1);o(this,"_renderer",pr);o(this,"_currentRenderer",_r);o(this,"dirty",!1);o(this,"_debug",Hi);o(this,"_enableIds",!1);o(this,"lodUpdateDistance",1);o(this,"lodUpdateAngle",0);o(this,"_lodBehindPenalty",1);o(this,"_lodUnderfillLimit",0);o(this,"_splatBudget",0);o(this,"_colorRamp",null);o(this,"colorRampIntensity",1);o(this,"useFog",!0);o(this,"colorUpdateAngle",10);o(this,"_fisheye",0);o(this,"cooldownTicks",100);o(this,"_varyings");o(this,"_appliedVaryingsVersion",0);this._device=t,this._currentRenderer=this._resolveRenderer(this._renderer),this._format=this._createFormat(mr),this._varyings=new Pg(t),this._material.setParameter("alphaClip",.3),this._material.setParameter("alphaClipForward",1/255),this._material.setParameter("minPixelSize",2),this._material.setParameter("minContribution",3),this._material.setParameter("foveationStrength",0),this._material.setParameter("foveationCenter",.3)}_createFormat(t){let e;if(t===mr)e=new Ps(this._device,[{name:"dataColor",format:ds},{name:"dataTransformA",format:pa},{name:"dataTransformB",format:ds}],{readGLSL:Ig,readWGSL:Ng}),e.setWriteCode(bg,Og);else{const i=this._device.getRenderableHdrFormat([Ue])||Nn;e=new Ps(this._device,[{name:"dataColor",format:i},{name:"dataTransformA",format:pa},{name:"dataTransformB",format:Mn}],{readGLSL:Rg,readWGSL:Fg}),e.setWriteCode(Mg,Ug)}return e.allowStreamRemoval=!0,e.dataFormat=t,e}_resolveRenderer(t){return t===pr?this._device.isWebGPU?ml:_r:t===ml&&!this._device.isWebGPU?_r:t}set renderer(t){t===bp&&(t=pr),this._renderer!==t&&(this._renderer=t,this._currentRenderer=this._resolveRenderer(t))}get renderer(){return this._renderer}get currentRenderer(){return this._currentRenderer}set debug(t){if(t!==Rp&&this._debug!==t){const e=this._debug;this._debug=t,(t===Gs||e===Gs)&&(this.dirty=!0)}}get debug(){return this._debug}set colorizeLod(t){this.debug=t?Gs:Hi}get colorizeLod(){return this._debug===Gs}set debugAabbs(t){this.debug=t?_l:Hi}get debugAabbs(){return this._debug===_l}set debugNodeAabbs(t){this.debug=t?gl:Hi}get debugNodeAabbs(){return this._debug===gl}set enableIds(t){t&&!this._enableIds?(this._enableIds=!0,this._format.getStream("pcId")||this._format.addExtraStreams([{name:"pcId",format:ds}])):!t&&this._enableIds&&(this._enableIds=!1,this._format.removeExtraStreams(["pcId"]))}get enableIds(){return this._enableIds}set lodBehindPenalty(t){this._lodBehindPenalty!==t&&(this._lodBehindPenalty=t,this.dirty=!0)}get lodBehindPenalty(){return this._lodBehindPenalty}set lodRangeMin(t){}get lodRangeMin(){return 0}set lodRangeMax(t){}get lodRangeMax(){return 99}set lodUnderfillLimit(t){this._lodUnderfillLimit!==t&&(this._lodUnderfillLimit=t,this.dirty=!0)}get lodUnderfillLimit(){return this._lodUnderfillLimit}set splatBudget(t){this._splatBudget!==t&&(this._splatBudget=t,this.dirty=!0)}get splatBudget(){return this._splatBudget}set colorRamp(t){this._colorRamp!==t&&(this._colorRamp=t,this.dirty=!0)}get colorRamp(){return this._colorRamp}set colorizeColorUpdate(t){this.debug=t?pl:Hi}get colorizeColorUpdate(){return this._debug===pl}set colorUpdateDistance(t){}get colorUpdateDistance(){return 0}set colorUpdateDistanceLodScale(t){}get colorUpdateDistanceLodScale(){return 0}set colorUpdateAngleLodScale(t){}get colorUpdateAngleLodScale(){return 0}set alphaClip(t){this._material.setParameter("alphaClip",t),this._material.update()}get alphaClip(){var t;return((t=this._material.getParameter("alphaClip"))==null?void 0:t.data)??.3}set alphaClipForward(t){this._material.setParameter("alphaClipForward",t),this._material.update()}get alphaClipForward(){var t;return((t=this._material.getParameter("alphaClipForward"))==null?void 0:t.data)??1/255}set minPixelSize(t){this._material.setParameter("minPixelSize",t),this._material.update()}get minPixelSize(){var t;return((t=this._material.getParameter("minPixelSize"))==null?void 0:t.data)??2}set minContribution(t){this._material.setParameter("minContribution",t),this._material.update()}get minContribution(){var t;return((t=this._material.getParameter("minContribution"))==null?void 0:t.data)??3}set foveationStrength(t){this._material.setParameter("foveationStrength",t),this._material.update()}get foveationStrength(){var t;return((t=this._material.getParameter("foveationStrength"))==null?void 0:t.data)??0}set foveationCenter(t){this._material.setParameter("foveationCenter",t),this._material.update()}get foveationCenter(){var t;return((t=this._material.getParameter("foveationCenter"))==null?void 0:t.data)??.3}set antiAlias(t){this._material.setDefine("GSPLAT_AA",t),this._material.update()}get antiAlias(){return!!this._material.getDefine("GSPLAT_AA")}set twoDimensional(t){this._material.setDefine("GSPLAT_2DGS",t),this._material.update()}get twoDimensional(){return!!this._material.getDefine("GSPLAT_2DGS")}set fisheye(t){if(this._fisheye!==t){const e=this._fisheye>0;this._fisheye=t;const i=t>0;e!==i&&(this._material.setDefine("GSPLAT_FISHEYE",i),this._material.update())}}get fisheye(){return this._fisheye}set dataFormat(t){if(this._dataFormat!==t){this._dataFormat=t;const e=this._format.extraStreams.map(i=>({name:i.name,format:i.format,storage:i.storage}));this._format=this._createFormat(t),e.length>0&&this._format.addExtraStreams(e),this.dirty=!0}}get dataFormat(){return this._dataFormat}get material(){return this._material}get format(){return this._format}get varyings(){return this._varyings}applySettings(t){this.radialSorting=t.gsplatRadialSorting??this.radialSorting,this.lodUpdateDistance=t.gsplatLodUpdateDistance??this.lodUpdateDistance,this.lodUpdateAngle=t.gsplatLodUpdateAngle??this.lodUpdateAngle,this.lodBehindPenalty=t.gsplatLodBehindPenalty??this.lodBehindPenalty,this.lodUnderfillLimit=t.gsplatLodUnderfillLimit??this.lodUnderfillLimit,this.splatBudget=t.gsplatSplatBudget??this.splatBudget,this.alphaClip=t.gsplatAlphaClip??this.alphaClip,this.alphaClipForward=t.gsplatAlphaClipForward??this.alphaClipForward,this.minPixelSize=t.gsplatMinPixelSize??this.minPixelSize,this.minContribution=t.gsplatMinContribution??this.minContribution,this.foveationStrength=t.gsplatFoveationStrength??this.foveationStrength,this.foveationCenter=t.gsplatFoveationCenter??this.foveationCenter,this.antiAlias=t.gsplatAntiAlias??this.antiAlias,this.useFog=t.gsplatUseFog??this.useFog,this.colorUpdateAngle=t.gsplatColorUpdateAngle??this.colorUpdateAngle,this.cooldownTicks=t.gsplatCooldownTicks??this.cooldownTicks,this.dataFormat=t.gsplatDataFormat??this.dataFormat,this.enableIds=t.gsplatEnableIds??this.enableIds}frameEnd(){this._material.dirty=!1,this.dirty=!1}frameUpdate(){this._appliedVaryingsVersion!==this._varyings.version&&(this._appliedVaryingsVersion=this._varyings.version,this._varyings.apply(this._material))}}class kg{constructor(){o(this,"enabled",!1);o(this,"k",1);o(this,"invK",1);o(this,"cornerScale",1);o(this,"projMat00",1);o(this,"projMat11",1);o(this,"maxTheta",Math.PI);o(this,"_lastT",-1);o(this,"_lastFov",-1);o(this,"_lastP00",0);o(this,"_lastP11",0)}update(t,e,i){i.data[15]===1&&(t=0);const s=i.data[0],a=i.data[5];if(t===this._lastT&&e===this._lastFov&&s===this._lastP00&&a===this._lastP11)return;if(this._lastT=t,this._lastFov=e,this._lastP00=s,this._lastP11=a,t<=0){this.enabled=!1,this.k=1,this.invK=1,this.cornerScale=1,this.maxTheta=Math.PI;return}this.enabled=!0;const r=e/180+.15,n=Math.max(1,e/180+.05),l=n*Math.pow(r/n,t);this.k=l,this.invK=1/l,this.cornerScale=1+(Math.SQRT2-1)*t;const d=Math.min(l*Math.PI/2,3.13),f=this.cornerScale,h=Math.atan2(1,s),u=Math.min(h,d-.01);this.projMat00=f/(l*Math.tan(u/l));const m=Math.atan2(1,a),p=Math.min(m,d-.01);this.projMat11=f/(l*Math.tan(p/l)),this.maxTheta=d}}const zg={linear:"decodeLinear",srgb:"decodeGamma",rgbm:"decodeRGBM",rgbe:"decodeRGBE",rgbp:"decodeRGBP",xy:"unpackNormalXY",xyz:"unpackNormalXYZ"},Vg={linear:"encodeLinear",srgb:"encodeGamma",rgbm:"encodeRGBM",rgbe:"encodeRGBE",rgbp:"encodeRGBP"};class Bt{static decodeFunc(t){return zg[t]??"decodeGamma"}static encodeFunc(t){return Vg[t]??"encodeGamma"}}const Gg=(c,t)=>{const e=t.length/3,i=c.length/3,s=new _,a=new _,r=new _,n=new _,l=new _,d=new _,f=[];for(let h=0;h<c.length;h++)f[h]=0;for(let h=0;h<e;h++){const u=t[h*3],m=t[h*3+1],p=t[h*3+2];s.set(c[u*3],c[u*3+1],c[u*3+2]),a.set(c[m*3],c[m*3+1],c[m*3+2]),r.set(c[p*3],c[p*3+1],c[p*3+2]),n.sub2(a,s),l.sub2(r,s),d.cross(n,l).normalize(),f[u*3]+=d.x,f[u*3+1]+=d.y,f[u*3+2]+=d.z,f[m*3]+=d.x,f[m*3+1]+=d.y,f[m*3+2]+=d.z,f[p*3]+=d.x,f[p*3+1]+=d.y,f[p*3+2]+=d.z}for(let h=0;h<i;h++){const u=f[h*3],m=f[h*3+1],p=f[h*3+2],g=1/Math.sqrt(u*u+m*m+p*p);f[h*3]*=g,f[h*3+1]*=g,f[h*3+2]*=g}return f},Vt=(c,t,e,i)=>{const s=i.length/3,a=c.length/3,r=new _,n=new _,l=new _,d=new k,f=new k,h=new k,u=new _,m=new _,p=new Float32Array(a*3),g=new Float32Array(a*3),v=[];for(let C=0;C<s;C++){const x=i[C*3],w=i[C*3+1],A=i[C*3+2];r.set(c[x*3],c[x*3+1],c[x*3+2]),n.set(c[w*3],c[w*3+1],c[w*3+2]),l.set(c[A*3],c[A*3+1],c[A*3+2]),d.set(e[x*2],e[x*2+1]),f.set(e[w*2],e[w*2+1]),h.set(e[A*2],e[A*2+1]);const L=n.x-r.x,D=l.x-r.x,b=n.y-r.y,N=l.y-r.y,U=n.z-r.z,R=l.z-r.z,j=f.x-d.x,O=h.x-d.x,M=f.y-d.y,H=h.y-d.y,Ze=j*H-O*M;if(Ze===0)u.set(0,1,0),m.set(1,0,0);else{const di=1/Ze;u.set((H*L-M*D)*di,(H*b-M*N)*di,(H*U-M*R)*di),m.set((j*D-O*L)*di,(j*N-O*b)*di,(j*R-O*U)*di)}p[x*3+0]+=u.x,p[x*3+1]+=u.y,p[x*3+2]+=u.z,p[w*3+0]+=u.x,p[w*3+1]+=u.y,p[w*3+2]+=u.z,p[A*3+0]+=u.x,p[A*3+1]+=u.y,p[A*3+2]+=u.z,g[x*3+0]+=m.x,g[x*3+1]+=m.y,g[x*3+2]+=m.z,g[w*3+0]+=m.x,g[w*3+1]+=m.y,g[w*3+2]+=m.z,g[A*3+0]+=m.x,g[A*3+1]+=m.y,g[A*3+2]+=m.z}const E=new _,S=new _,T=new _,y=new _;for(let C=0;C<a;C++){T.set(t[C*3],t[C*3+1],t[C*3+2]),E.set(p[C*3],p[C*3+1],p[C*3+2]),S.set(g[C*3],g[C*3+1],g[C*3+2]);const x=T.dot(E);y.copy(T).mulScalar(x),y.sub2(E,y).normalize(),v[C*4]=y.x,v[C*4+1]=y.y,v[C*4+2]=y.z,y.cross(T,E),v[C*4+3]=y.dot(S)<0?-1:1}return v};class Ms{constructor(){o(this,"positions");o(this,"normals");o(this,"colors");o(this,"uvs");o(this,"uvs1");o(this,"blendIndices");o(this,"blendWeights");o(this,"tangents");o(this,"indices")}calculateNormals(){this.normals=Gg(this.positions,this.indices)}calculateTangents(){this.tangents=Vt(this.positions,this.normals,this.uvs,this.indices)}}const Tn=8/64,ac=1-Tn*2;class En extends Ms{constructor(t={}){super();const e=t.halfExtents??new _(.5,.5,.5),i=t.widthSegments??1,s=t.lengthSegments??1,a=t.heightSegments??1,r=t.yOffset??0,n=-e.y+r,l=e.y+r,d=[new _(-e.x,n,e.z),new _(e.x,n,e.z),new _(e.x,l,e.z),new _(-e.x,l,e.z),new _(e.x,n,-e.z),new _(-e.x,n,-e.z),new _(-e.x,l,-e.z),new _(e.x,l,-e.z)],f=[[0,1,3],[4,5,7],[3,2,6],[1,0,4],[1,4,2],[5,0,6]],h=[[0,0,1],[0,0,-1],[0,1,0],[0,-1,0],[1,0,0],[-1,0,0]],u={FRONT:0,BACK:1,TOP:2,BOTTOM:3,RIGHT:4,LEFT:5},m=[],p=[],g=[],v=[],E=[];let S=0;const T=(y,C,x)=>{const w=new _,A=new _,L=new _,D=new _;for(let b=0;b<=C;b++)for(let N=0;N<=x;N++){w.lerp(d[f[y][0]],d[f[y][1]],b/C),A.lerp(d[f[y][0]],d[f[y][2]],N/x),L.sub2(A,d[f[y][0]]),D.add2(w,L);let U=b/C,R=N/x;m.push(D.x,D.y,D.z),p.push(h[y][0],h[y][1],h[y][2]),g.push(U,1-R),U=U*ac+Tn,R=R*ac+Tn,U/=3,R/=3,U+=y%3/3,R+=Math.floor(y/3)/3,v.push(U,1-R),b<C&&N<x&&(E.push(S+x+1,S+1,S),E.push(S+x+1,S+x+2,S+1)),S++}};T(u.FRONT,i,a),T(u.BACK,i,a),T(u.TOP,i,s),T(u.BOTTOM,i,s),T(u.RIGHT,s,a),T(u.LEFT,s,a),this.positions=m,this.normals=p,this.uvs=g,this.uvs1=v,this.indices=E,t.calculateTangents&&(this.tangents=Vt(m,p,g,E))}}class Dh extends Ms{constructor(t={}){super();const e=t.radius??.5,i=t.latitudeBands??16,s=t.longitudeBands??16,a=[],r=[],n=[],l=[];for(let d=0;d<=i;d++){const f=d*Math.PI/i,h=Math.sin(f),u=Math.cos(f);for(let m=0;m<=s;m++){const p=m*2*Math.PI/s-Math.PI/2,g=Math.sin(p),E=Math.cos(p)*h,S=u,T=g*h,y=1-m/s,C=1-d/i;a.push(E*e,S*e,T*e),r.push(E,S,T),n.push(y,1-C)}}for(let d=0;d<i;++d)for(let f=0;f<s;++f){const h=d*(s+1)+f,u=h+s+1;l.push(h+1,u,h),l.push(h+1,u+1,u)}this.positions=a,this.normals=r,this.uvs=n,this.uvs1=n,this.indices=l,t.calculateTangents&&(this.tangents=Vt(a,r,n,l))}}class Hg extends Dh{constructor(t={}){const i=t.latitudeBands??16,s=t.longitudeBands??16;super({radius:.5,latitudeBands:i,longitudeBands:s});const a=.1,r=.95,n=r*r,l=this.positions;for(let d=0;d<l.length;d+=3){const f=l[d]/.5;let h=l[d+1]/.5;const u=l[d+2]/.5;h<0&&(h*=.3,f*f+u*u<n&&(h=-a)),h+=a,h*=.5,l[d+1]=h}}}class us{static create(t,e){switch(e){case Sp:return us.box(t);case Tp:return us.dome(t)}return us.infinite(t)}static infinite(t){return xe.fromGeometry(t,new En(t))}static box(t){return xe.fromGeometry(t,new En({yOffset:.5}))}static dome(t){const e=new Hg({latitudeBands:50,longitudeBands:50});return e.normals=void 0,e.uvs=void 0,xe.fromGeometry(t,e)}}class Wg{constructor(t,e,i,s,a){o(this,"meshInstance",null);o(this,"_depthWrite",!1);const r=new Ds({uniqueName:"SkyMaterial",vertexGLSL:ne.get(t,ae).get("skyboxVS"),fragmentGLSL:ne.get(t,ae).get("skyboxPS"),vertexWGSL:ne.get(t,ue).get("skyboxVS"),fragmentWGSL:ne.get(t,ue).get("skyboxPS"),attributes:{aPosition:ge}});r.setDefine("{SKYBOX_DECODE_FNC}",Bt.decodeFunc(s.encoding)),a!==Ei&&r.setDefine("SKYMESH",""),s.cubemap&&r.setDefine("SKY_CUBEMAP",""),r.setParameter("skyboxHighlightMultiplier",e.skyboxHighlightMultiplier),s.cubemap?r.setParameter("texture_cubeMap",s):(r.setParameter("texture_envAtlas",s),r.setParameter("mipLevel",e.skyboxMip)),r.cull=Tf,r.depthWrite=this._depthWrite;const n=e.layers.getLayerById(eo);if(n){const l=us.create(t,a),d=new zt(l,r,i);this.meshInstance=d,d.cull=!1,d.pick=!1,n.addMeshInstances([d]),this.skyLayer=n}}destroy(){this.meshInstance&&(this.skyLayer&&this.skyLayer.removeMeshInstances([this.meshInstance]),this.meshInstance.destroy(),this.meshInstance=null)}set depthWrite(t){this._depthWrite=t,this.meshInstance&&(this.meshInstance.material.depthWrite=t)}get depthWrite(){return this._depthWrite}}class Xg{constructor(t){o(this,"_type",Ei);o(this,"_center",new _(0,1,0));o(this,"skyMesh",null);o(this,"_depthWrite",!1);o(this,"_fisheye",0);o(this,"_fisheyeProj",null);o(this,"node",new Bi("SkyMeshNode"));this.device=t.device,this.scene=t,this.center=new _(0,1,0),this.centerArray=new Float32Array(3),this.projectedSkydomeCenterId=this.device.scope.resolve("projectedSkydomeCenter"),this._preRenderEvt=t.on("prerender",this._onPreRender,this)}destroy(){this._preRenderEvt.off(),this.resetSkyMesh()}applySettings(t){this.type=t.skyType??Ei,this.node.setLocalPosition(new _(t.skyMeshPosition??[0,0,0])),this.node.setLocalEulerAngles(new _(t.skyMeshRotation??[0,0,0])),this.node.setLocalScale(new _(t.skyMeshScale??[1,1,1])),t.skyCenter&&(this._center=new _(t.skyCenter))}set type(t){this._type!==t&&(this._type=t,this.scene.updateShaders=!0,this.updateSkyMesh())}get type(){return this._type}set center(t){this._center.copy(t)}get center(){return this._center}set depthWrite(t){this._depthWrite!==t&&(this._depthWrite=t,this.skyMesh&&(this.skyMesh.depthWrite=t))}get depthWrite(){return this._depthWrite}set fisheye(t){if(this._fisheye!==t){const e=this._fisheye>0;this._fisheye=t;const i=t>0;e!==i&&(this._fisheyeProj??(this._fisheyeProj=new kg),this._type===Ei&&this._setFisheyeDefine(i))}}get fisheye(){return this._fisheye}updateSkyMesh(){const t=this.scene._getSkyboxTex();t&&(this.resetSkyMesh(),this.skyMesh=new Wg(this.device,this.scene,this.node,t,this.type),this.skyMesh.depthWrite=this._depthWrite,this._fisheye>0&&this.type===Ei&&this._setFisheyeDefine(!0),this.scene.fire("set:skybox",t))}resetSkyMesh(){var t;(t=this.skyMesh)==null||t.destroy(),this.skyMesh=null}update(){if(this.type!==Ei){const{center:t,centerArray:e}=this,i=new _;this.node.getWorldTransform().transformPoint(t,i),e[0]=i.x,e[1]=i.y,e[2]=i.z,this.projectedSkydomeCenterId.setValue(e)}}_setFisheyeDefine(t){var e;if((e=this.skyMesh)!=null&&e.meshInstance){const i=this.skyMesh.meshInstance.material;i.setDefine("SKY_FISHEYE",t),i.update()}}_onPreRender(t){var e;if(this._fisheye>0&&this._fisheyeProj&&((e=this.skyMesh)!=null&&e.meshInstance)){const i=t.camera,s=this._fisheyeProj;s.update(this._fisheye,i.fov,i.projectionMatrix);const a=this.skyMesh.meshInstance.material;a.setParameter("fisheye_k",s.k),a.setParameter("fisheye_invK",s.invK),a.setParameter("fisheye_projMat00",s.projMat00),a.setParameter("fisheye_projMat11",s.projMat11)}}}const Pa=new Bi;Pa.worldTransform=I.IDENTITY;Pa._dirtyWorld=Pa._dirtyNormal=!1;class Yg{constructor(t,e,i){this.material=e,this.layer=i,this.positions=[],this.colors=[],this.mesh=new xe(t),this.meshInstance=null}addLines(t,e){const i=this.positions,s=t.length;for(let r=0;r<s;r++){const n=t[r];i.push(n.x,n.y,n.z)}const a=this.colors;if(e.length)for(let r=0;r<s;r++){const n=e[r];a.push(n.r,n.g,n.b,n.a)}else for(let r=0;r<s;r++)a.push(e.r,e.g,e.b,e.a)}addLinesArrays(t,e){const i=this.positions;for(let a=0;a<t.length;a+=3)i.push(t[a],t[a+1],t[a+2]);const s=this.colors;if(e.length)for(let a=0;a<e.length;a+=4)s.push(e[a],e[a+1],e[a+2],e[a+3]);else{const a=t.length/3;for(let r=0;r<a;r++)s.push(e.r,e.g,e.b,e.a)}}onPreRender(t,e){this.positions.length>0&&this.material.transparent===e&&(this.mesh.setPositions(this.positions),this.mesh.setColors(this.colors),this.mesh.update(ld,!1),this.meshInstance||(this.meshInstance=new zt(this.mesh,this.material,Pa)),t.push(this.meshInstance))}clear(){this.positions.length=0,this.colors.length=0}}class $g{constructor(t){this.device=t,this.map=new Map}getBatch(t,e){let i=this.map.get(t);return i||(i=new Yg(this.device,t,e),this.map.set(t,i)),i}onPreRender(t,e){this.map.forEach(i=>{i.onPreRender(t,e)})}clear(){this.map.forEach(t=>t.clear())}}const Ne=[],vi=new _;class qg{constructor(t){o(this,"shaderDescs",new Map);this.device=t,this.quadMesh=null,this.textureShader=null,this.depthTextureShader=null,this.cubeLocalPos=null,this.cubeWorldPos=null,this.batchesMap=new Map,this.allBatches=new Set,this.updatedLayers=new Set,this._materialDepth=null,this._materialNoDepth=null,this.layerMeshInstances=new Map}createMaterial(t){const e=new Ds({uniqueName:"ImmediateLine",vertexGLSL:ne.get(this.device,ae).get("immediateLineVS"),fragmentGLSL:ne.get(this.device,ae).get("immediateLinePS"),vertexWGSL:ne.get(this.device,ue).get("immediateLineVS"),fragmentWGSL:ne.get(this.device,ue).get("immediateLinePS"),attributes:{vertex_position:ge,vertex_color:gt}});return e.blendType=St,e.depthTest=t,e.update(),e}get materialDepth(){return this._materialDepth||(this._materialDepth=this.createMaterial(!0)),this._materialDepth}get materialNoDepth(){return this._materialNoDepth||(this._materialNoDepth=this.createMaterial(!1)),this._materialNoDepth}getBatch(t,e){let i=this.batchesMap.get(t);i||(i=new $g(this.device),this.batchesMap.set(t,i)),this.allBatches.add(i);const s=e?this.materialDepth:this.materialNoDepth;return i.getBatch(s,t)}getShaderDesc(t,e,i){return this.shaderDescs.has(t)||this.shaderDescs.set(t,{uniqueName:`DebugShader:${t}`,vertexGLSL:`
				...
				`,fragmentGLSL:e,fragmentWGSL:i,attributes:{vertex_position:ge}}),this.shaderDescs.get(t)}getTextureShaderDesc(t){const e=Bt.decodeFunc(t);return this.getShaderDesc(`textureShader-${t}`,`
			#include "gammaPS"
			varying vec2 uv0;
...
`;const $T={alphaTestPS:rS,ambientPS:nS,anisotropyPS:oS,aoPS:lS,aoDiffuseOccPS:cS,aoSpecOccPS:dS,bakeDirLmEndPS:hS,bakeLmEndPS:fS,basePS:uS,baseNineSlicedPS:mS,baseNineSlicedTiledPS:pS,bayerPS:_S,blurVSMPS:gS,clearCoatPS:vS,clearCoatGlossPS:SS,clearCoatNormalPS:TS,clusteredLightCookiesPS:yS,clusteredLightShadowsPS:xS,clusteredLightUtilsPS:ES,clusteredLightPS:CS,combinePS:wS,cookieBlit2DPS:AS,cookieBlitCubePS:LS,cookieBlitVS:DS,cookiePS:PS,cubeMapProjectPS:IS,cubeMapRotatePS:bS,debugOutputPS:RS,debugProcessFrontendPS:MS,detailModesPS:OS,diffusePS:FS,decodePS:NS,emissivePS:US,encodePS:BS,endPS:kS,envAtlasPS:zS,envProcPS:VS,falloffInvSquaredPS:GS,falloffLinearPS:HS,floatAsUintPS:WS,fogPS:XS,fresnelSchlickPS:YS,frontendCodePS:"",frontendDeclPS:"",fullscreenQuadVS:$S,gammaPS:qS,gles3PS:Vd,gles3VS:Gd,glossPS:jS,quadVS:KS,immediateLinePS:ZS,immediateLineVS:JS,iridescenceDiffractionPS:QS,iridescencePS:e0,iridescenceThicknessPS:t0,iorPS:i0,lightDeclarationPS:s0,lightDiffuseLambertPS:a0,lightDirPointPS:r0,lightEvaluationPS:n0,lightFunctionLightPS:o0,lightFunctionShadowPS:l0,lightingPS:c0,lightmapAddPS:d0,lightmapPS:h0,lightSpecularAnisoGGXPS:f0,lightSpecularGGXPS:u0,lightSpecularBlinnPS:m0,lightSheenPS:p0,linearizeDepthPS:_0,litForwardBackendPS:g0,litForwardDeclarationPS:v0,litForwardMainPS:S0,litForwardPostCodePS:T0,litForwardPreCodePS:E0,litMainPS:y0,litMainVS:x0,litOtherMainPS:C0,litShaderArgsPS:w0,litShaderCorePS:A0,litShadowMainPS:L0,litUserDeclarationPS:"",litUserDeclarationVS:"",litUserCodePS:"",litUserCodeVS:"",litUserMainStartPS:"",litUserMainStartVS:"",litUserMainEndPS:"",litUserMainEndVS:"",ltcPS:D0,metalnessPS:P0,metalnessModulatePS:b0,morphPS:R0,morphVS:M0,msdfPS:I0,msdfVS:N0,normalVS:O0,normalCoreVS:F0,normalMapPS:U0,opacityPS:B0,opacityDitherPS:k0,outlineDeclarationPS:z0,outlineOutputPS:V0,outputPS:G0,outputAlphaPS:H0,outputTex2DPS:W0,sheenPS:X0,sheenGlossPS:Y0,parallaxPS:$0,pickPS:q0,reflDirPS:j0,reflDirAnisoPS:K0,reflectionCCPS:Z0,reflectionCubePS:J0,reflectionEnvHQPS:Q0,reflectionEnvPS:eT,reflectionSpherePS:tT,reflectionSheenPS:iT,refractionCubePS:sT,refractionDynamicPS:aT,reprojectPS:rT,reprojectVS:nT,screenDepthPS:oT,shadowCascadesPS:lT,shadowEVSMPS:cT,shadowPCF1PS:dT,shadowPCF3PS:hT,shadowPCF5PS:fT,shadowPCSSPS:uT,shadowSoftPS:mT,skinBatchVS:pT,skinVS:_T,skyboxPS:gT,skyboxVS:vT,specularPS:ST,sphericalPS:TT,specularityFactorPS:ET,spotPS:yT,startNineSlicedPS:xT,startNineSlicedTiledPS:CT,stdDeclarationPS:wT,stdFrontEndPS:AT,TBNPS:LT,thicknessPS:DT,tonemappingPS:PT,tonemappingAcesPS:IT,tonemappingAces2PS:bT,tonemappingFilmicPS:RT,tonemappingHejlPS:MT,tonemappingLinearPS:NT,tonemappingNeutralPS:OT,tonemappingNonePS:FT,transformVS:UT,transformCoreVS:BT,transformInstancingVS:kT,transmissionPS:zT,twoSidedLightingPS:VT,uv0VS:GT,uv1VS:HT,uvTransformVS:WT,uvTransformUniformsPS:XT,viewDirPS:YT,webgpuPS:Hd,webgpuVS:Wd};var qT=`
